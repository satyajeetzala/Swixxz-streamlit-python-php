...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE tandc SET tctext = ?";
    ...
    if (mysqli_stmt_execute($stmt)) {
        echo "<p class='text-green-500'>Terms and Conditions updated successfully!</p>";
    } else {
...
<div class="container mx-auto p-8">
    <div class="bg-gray-800 bg-opacity-50 text-white p-8 shadow-md rounded-md">
        <h2 class="text-3xl font-semibold mb-4">Update Terms and Conditions</h2>
