...
<body class="font-sans bg-gray-100 relative">
    ...
    <div id="navbar">
        ...
        <a href="#" class="hover:text-pink-700 pt-4 text-xl">Home</a>
        <a href="#" class="hover:text-pink-700 pt-4 text-xl">Genres</a>
        <a href="#" class="hover:text-pink-700 pt-4 text-xl">Artists</a>
        <a href="#" class="hover:text-pink-700 pt-4 text-xl">Playlists</a>
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="https://www.swixxz.com/cdn/shop/files/attempt6_480x.gif?v=1614301760" class="h-8 me-3" alt="FlowBite Logo" />
